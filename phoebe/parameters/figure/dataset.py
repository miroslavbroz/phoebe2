...
def etv(b, **kwargs):
    ...
    params += [ChoiceParameter(qualifier='x', value=kwargs.get('x', 'time_ephs'), choices=['time_ephs', 'Ns'], description='Array to plot along x-axis')]
    params += [ChoiceParameter(qualifier='y', value=kwargs.get('y', 'etvs'), choices=['etvs', 'times'], description='Array to plot along y-axis')]

    params += _label_units_lims('x', visible_if='x:time_ephs', default_unit=u.d, is_default=True, **kwargs)
    params += _label_units_lims('y', visible_if='y:etvs', default_unit=u.d, is_default=True, **kwargs)
    params += _label_units_lims('y', visible_if='y:times', default_unit=u.d, **kwargs)
